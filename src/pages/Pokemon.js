...
export default function PokemonPage() {
    ...
    function togglePokemon() {
        if (pokemon.inMyPokemons) {
            axios.post(`https://pokedex-api-backend.herokuapp.com/my-pokemons/${id}/remove`, null, {
                headers: {
            ...
            axios.post(`https://pokedex-api-backend.herokuapp.com/my-pokemons/${id}/add`, null, {
                headers: {
                    Authorization: `Bearer ${token.token}`
                }
            }).then(() => {
